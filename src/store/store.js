...
export const store = new Vuex.Store({
    state: {
        ...
        toneChain:[
            ...
            {id:2,  toneID:2,  name:'F#1',tone: 'Fs1', linePos:1,  enh:[3],     prev:1,  next:4 },
            {id:3,  toneID:2,  name:'Gb1',tone: 'Fs1', linePos:2,  enh:[2],     prev:1,  next:4 },
            {id:4,  toneID:3,  name:'G1' ,tone: 'G1' , linePos:2,  enh:[66,67], prev:3,  next:5 },
            {id:5,  toneID:4,  name:'G#1',tone: 'Gs1', linePos:2,  enh:[6],     prev:4,  next:7 },
            {id:6,  toneID:4,  name:'Ab1',tone: 'Gs1', linePos:3,  enh:[5],     prev:4,  next:7 },
            {id:7,  toneID:5,  name:'A1' ,tone: 'A1' , linePos:3,  enh:[68,69], prev:6,  next:8 },
            {id:8,  toneID:6,  name:'A#1',tone: 'As1', linePos:3,  enh:[9],     prev:7,  next:10},
            {id:9,  toneID:6,  name:'Bb1',tone: 'As1', linePos:4,  enh:[8],     prev:7,  next:10},
            ...
            {id:12, toneID:9,  name:'C#2',tone: 'Cs2', linePos:5,  enh:[13],    prev:11, next:14},
            {id:13, toneID:9,  name:'Db2',tone: 'Cs2', linePos:6,  enh:[12],    prev:11, next:14},
            {id:14, toneID:10, name:'D2' ,tone: 'D2' , linePos:6,  enh:[74,75], prev:13, next:15},
            {id:15, toneID:11, name:'D#2',tone: 'Ds2', linePos:6,  enh:[16],    prev:14, next:17},
            {id:16, toneID:11, name:'Eb2',tone: 'Ds2', linePos:7,  enh:[15],    prev:14, next:17},
            ...
            {id:19, toneID:14, name:'F#2',tone: 'Fs2', linePos:8,  enh:[20],    prev:18, next:21},
            {id:20, toneID:14, name:'Gb2',tone: 'Fs2', linePos:9,  enh:[19],    prev:18, next:21},
            {id:21, toneID:15, name:'G2' ,tone: 'G2' , linePos:9,  enh:[80,81], prev:20, next:22},
            {id:22, toneID:16, name:'G#2',tone: 'Gs2', linePos:9,  enh:[23],    prev:21, next:24},
            {id:23, toneID:16, name:'Ab2',tone: 'Gs2', linePos:10, enh:[22],    prev:21, next:24},
            {id:24, toneID:17, name:'A2' ,tone: 'A2' , linePos:10, enh:[82,83], prev:23, next:25},
            {id:25, toneID:18, name:'A#2',tone: 'As2', linePos:10, enh:[26],    prev:24, next:27},
            {id:26, toneID:18, name:'Bb2',tone: 'As2', linePos:11, enh:[25],    prev:24, next:27},
            ...
            {id:29, toneID:21, name:'C#3',tone: 'Cs3', linePos:12, enh:[30],    prev:28, next:31},
            {id:30, toneID:21, name:'Db3',tone: 'Cs3', linePos:13, enh:[29],    prev:28, next:31},
            {id:31, toneID:22, name:'D3' ,tone: 'D3' , linePos:13, enh:[88,89], prev:30, next:32},
            {id:32, toneID:23, name:'D#3',tone: 'Ds3', linePos:13, enh:[33],    prev:31, next:34},
            {id:33, toneID:23, name:'Eb3',tone: 'Ds3', linePos:14, enh:[32],    prev:31, next:34},
            ...
            {id:36, toneID:26, name:'F#3',tone: 'Fs3', linePos:15, enh:[37],    prev:35, next:38},
            {id:37, toneID:26, name:'Gb3',tone: 'Fs3', linePos:16, enh:[36],    prev:35, next:38},
            {id:38, toneID:27, name:'G3' ,tone: 'G3' , linePos:16, enh:[94,95], prev:37, next:39},
            {id:39, toneID:28, name:'G#3',tone: 'Gs3', linePos:16, enh:[40],    prev:38, next:41},
            {id:40, toneID:28, name:'Ab3',tone: 'Gs3', linePos:17, enh:[39],    prev:38, next:41},
            {id:41, toneID:29, name:'A3' ,tone: 'A3' , linePos:17, enh:[96,97], prev:40, next:42},
            {id:42, toneID:30, name:'A#3',tone: 'As3', linePos:17, enh:[43],    prev:41, next:44},
            {id:43, toneID:30, name:'Bb3',tone: 'As3', linePos:18, enh:[42],    prev:41, next:44},
            ...
            {id:46, toneID:33, name:'C#4',tone: 'Cs4', linePos:19, enh:[47],    prev:45, next:48},
            {id:47, toneID:33, name:'Db4',tone: 'Cs4', linePos:20, enh:[46],    prev:45, next:48},
            {id:48, toneID:34, name:'D4' ,tone: 'D4' , linePos:20, enh:[102,103],prev:47, next:49},
            {id:49, toneID:35, name:'D#4',tone: 'Ds4', linePos:20, enh:[50],    prev:48, next:51},
            {id:50, toneID:35, name:'Eb4',tone: 'Ds4', linePos:21, enh:[49],    prev:48, next:51},
            ...
            {id:53, toneID:38, name:'F#4',tone: 'Fs4', linePos:22, enh:[54],    prev:52, next:55},
            {id:54, toneID:38, name:'Gb4',tone: 'Fs4', linePos:23, enh:[53],    prev:52, next:55},
            {id:55, toneID:39, name:'G4' ,tone: 'G4' , linePos:23, enh:[108,109],prev:54, next:56},
            {id:56, toneID:40, name:'G#4',tone: 'Gs4', linePos:23, enh:[57],    prev:55, next:58},
            {id:57, toneID:40, name:'Ab4',tone: 'Gs4', linePos:24, enh:[56],    prev:55, next:58},
            {id:58, toneID:41, name:'A4' ,tone: 'A4' , linePos:24, enh:[110,111],prev:57, next:59},
            {id:59, toneID:42, name:'A#4',tone: 'As4', linePos:24, enh:[60],    prev:58, next:61},
            {id:60, toneID:42, name:'Bb4',tone: 'As4', linePos:25, enh:[59],    prev:58, next:61},
            ...
            {id:86,  toneID:20, name:'B#2' ,tone:'C3', linePos:11, prev:27, next:29},
            {id:87,  toneID:20, name:'Dbb3',tone:'C3', linePos:13, prev:27, next:29},
